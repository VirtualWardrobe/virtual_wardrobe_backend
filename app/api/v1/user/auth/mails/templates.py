...
<head>
    ...
    <title>Virtual Wardrobe - Account Verification</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for joining Virtual Wardrobe! Please use the following OTP to verify your account:</p>
        ...
        <div class="footer">
            <p>© 2025 Virtual Wardrobe. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
